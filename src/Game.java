...
public class Game 
{
    ...
    public static void initPlayer()
    {
        ...
        try (Scanner input = new Scanner(System.in)) 
        {
            ...
            String resp_mod     = "";
            System.out.println( ANSI_BLUE + "-- Choisissez votre mode de jeu. --" + ANSI_WHITE + "\n");

            while( !resp_mod.equals("1") && !resp_mod.equals("2"))
            {
                System.out.println("Joueur vs. Joueur : 1 | Joueur vs. IA : 2");
                resp_mod = System.console().readLine();
            }
            
            isThereIA =  resp_mod.equals("2") ? true : false;
